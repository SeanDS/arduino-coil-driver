...
*/
abstract class OutputView implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ArduinoCoilDriver\\Outputs\\Map\\OutputViewTableMap';
     ...
     * @var ObjectCollection|ChildOutputViewOutput[]
     */
    protected $outputViewOutputsScheduledForDeletion = null;

    /**
     * Initializes internal state of ArduinoCoilDriver\Outputs\Base\OutputView object.
     */
    ...
    /**
     * Compares this with another <code>OutputView</code> instance.  If
     * <code>obj</code> is an instance of <code>OutputView</code>, delegates to
     * <code>equals(OutputView)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OutputView The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OutputViewTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[OutputViewTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OutputViewTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(OutputViewTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildOutputViewQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OutputView::setDeleted()
     * @see OutputView::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getWriteConnection(OutputViewTableMap::DATABASE_NAME);
        }

        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOutputViewQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OutputViewTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[OutputViewTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . OutputViewTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(OutputViewTableMap::COL_ID)) {
    ...
    {
        $pos = OutputViewTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['OutputView'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OutputView'][$this->hashCode()] = true;
        $keys = OutputViewTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ArduinoCoilDriver\Outputs\OutputView
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ArduinoCoilDriver\Outputs\OutputView The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(OutputViewTableMap::DATABASE_NAME);

        if ($this->isColumnModified(OutputViewTableMap::COL_ID)) {
            $criteria->add(OutputViewTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(OutputViewTableMap::COL_NAME)) {
    ...
    {
        $criteria = ChildOutputViewQuery::create();
        $criteria->add(OutputViewTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArduinoCoilDriver\Outputs\OutputView (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArduinoCoilDriver\Outputs\OutputView Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Gets an array of ChildOutputViewOutput objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildOutputView is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildOutputViewOutput[] List of ChildOutputViewOutput objects
     * @throws PropelException
     */
    public function getOutputViewOutputs(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collOutputViewOutputs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOutputViewOutputs) {
                ...
                $collOutputViewOutputs = ChildOutputViewOutputQuery::create(null, $criteria)
                    ->filterByOutputView($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildOutputViewOutput objects related by a one-to-many relationship
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildOutputView The current object (for fluent API support)
     */
    public function setOutputViewOutputs(Collection $outputViewOutputs, ConnectionInterface $con = null)
    {
        /** @var ChildOutputViewOutput[] $outputViewOutputsToDelete */
        ...
        foreach ($outputViewOutputsToDelete as $outputViewOutputRemoved) {
            $outputViewOutputRemoved->setOutputView(null);
        }
    ...
    /**
     * Returns the number of related OutputViewOutput objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related OutputViewOutput objects.
     * @throws PropelException
     */
    public function countOutputViewOutputs(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collOutputViewOutputs || null !== $criteria || $partial) {
            ...
            $query = ChildOutputViewOutputQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildOutputViewOutput object to this object
     * through the ChildOutputViewOutput foreign key attribute.
     *
     * @param  ChildOutputViewOutput $l ChildOutputViewOutput
     * @return $this|\ArduinoCoilDriver\Outputs\OutputView The current object (for fluent API support)
     */
    public function addOutputViewOutput(ChildOutputViewOutput $l)
    {
        if ($this->collOutputViewOutputs === null) {
            $this->initOutputViewOutputs();
            $this->collOutputViewOutputsPartial = true;
    ...
    /**
     * @param ChildOutputViewOutput $outputViewOutput The ChildOutputViewOutput object to add.
     */
    protected function doAddOutputViewOutput(ChildOutputViewOutput $outputViewOutput)
    {
        $this->collOutputViewOutputs[]= $outputViewOutput;
        $outputViewOutput->setOutputView($this);
    }

    /**
     * @param  ChildOutputViewOutput $outputViewOutput The ChildOutputViewOutput object to remove.
     * @return $this|ChildOutputView The current object (for fluent API support)
     */
    public function removeOutputViewOutput(ChildOutputViewOutput $outputViewOutput)
    {
        if ($this->getOutputViewOutputs()->contains($outputViewOutput)) {
            ...
            $outputViewOutput->setOutputView(null);
        }
     ...
     * Otherwise if this OutputView is new, it will return
     * an empty collection; or if this OutputView has previously
     * been saved, it will retrieve related OutputViewOutputs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OutputView.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildOutputViewOutput[] List of ChildOutputViewOutput objects
     */
    public function getOutputViewOutputsJoinDriverOutput(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOutputViewOutputQuery::create(null, $criteria);
        $query->joinWith('DriverOutput', $joinBehavior);
