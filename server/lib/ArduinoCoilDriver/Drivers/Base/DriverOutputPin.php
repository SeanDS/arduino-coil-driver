...
/**
 * Base class that represents a row from the 'driver_output_pins' table.
 *
 *
 *
* @package    propel.generator.ArduinoCoilDriver.Drivers.Base
*/
abstract class DriverOutputPin implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ArduinoCoilDriver\\Drivers\\Map\\DriverOutputPinTableMap';
    ...
    /**
     * Initializes internal state of ArduinoCoilDriver\Drivers\Base\DriverOutputPin object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>DriverOutputPin</code> instance.  If
     * <code>obj</code> is an instance of <code>DriverOutputPin</code>, delegates to
     * <code>equals(DriverOutputPin)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DriverOutputPin The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DriverOutputPinTableMap::COL_ID] = true;
        }
    ...
    public function setDriverOutputId($v)
    {
        ...
        if ($this->driver_output_id !== $v) {
            ...
            $this->modifiedColumns[DriverOutputPinTableMap::COL_DRIVER_OUTPUT_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[DriverOutputPinTableMap::COL_TYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DriverOutputPinTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = DriverOutputPinTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ArduinoCoilDriver\\Drivers\\DriverOutputPin'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDriverOutputPinQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DriverOutputPin::setDeleted()
     * @see DriverOutputPin::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDriverOutputPinQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DriverOutputPinTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DriverOutputPinTableMap::COL_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO driver_output_pins (%s) VALUES (%s)',
    ...
    {
        $pos = DriverOutputPinTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DriverOutputPin'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DriverOutputPin'][$this->hashCode()] = true;
        $keys = DriverOutputPinTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ArduinoCoilDriver\Drivers\DriverOutputPin
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ArduinoCoilDriver\Drivers\DriverOutputPin The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DriverOutputPinTableMap::COL_ID)) {
            $criteria->add(DriverOutputPinTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DriverOutputPinTableMap::COL_DRIVER_OUTPUT_ID)) {
    ...
    {
        $criteria = ChildDriverOutputPinQuery::create();
        $criteria->add(DriverOutputPinTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArduinoCoilDriver\Drivers\DriverOutputPin (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArduinoCoilDriver\Drivers\DriverOutputPin Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildDriverOutput object.
     *
     * @param  ChildDriverOutput $v
     * @return $this|\ArduinoCoilDriver\Drivers\DriverOutputPin The current object (for fluent API support)
     * @throws PropelException
     */
    public function setDriverOutput(ChildDriverOutput $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildDriverOutput object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated ChildDriverOutput object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildDriverOutput The associated ChildDriverOutput object.
     * @throws PropelException
     */
    public function getDriverOutput(ConnectionInterface $con = null)
    {
        if ($this->aDriverOutput === null && ($this->driver_output_id !== null)) {
            $this->aDriverOutput = ChildDriverOutputQuery::create()->findPk($this->driver_output_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDriverOutput->addDriverOutputPins($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DriverOutputPinTableMap::DEFAULT_STRING_FORMAT);
    }
