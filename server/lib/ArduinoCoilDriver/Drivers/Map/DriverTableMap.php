...
class DriverTableMap extends TableMap
{
     ...
     */
    const COL_LASTCHECKIN = 'drivers.lastcheckin';

    /**
     * the column name for the coilcontact field
     */
    const COL_COILCONTACT = 'drivers.coilcontact';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(DriverTableMap::COL_ID, DriverTableMap::COL_NAME, DriverTableMap::COL_MAC, DriverTableMap::COL_IP, DriverTableMap::COL_ADDED, DriverTableMap::COL_LASTCHECKIN, DriverTableMap::COL_COILCONTACT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'mac', 'ip', 'added', 'lastcheckin', 'coilcontact', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(DriverTableMap::COL_ID => 0, DriverTableMap::COL_NAME => 1, DriverTableMap::COL_MAC => 2, DriverTableMap::COL_IP => 3, DriverTableMap::COL_ADDED => 4, DriverTableMap::COL_LASTCHECKIN => 5, DriverTableMap::COL_COILCONTACT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'mac' => 2, 'ip' => 3, 'added' => 4, 'lastcheckin' => 5, 'coilcontact' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('coilcontact', 'CoilContact', 'BOOLEAN', true, 1, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DriverTableMap::COL_LASTCHECKIN);
            $criteria->addSelectColumn(DriverTableMap::COL_COILCONTACT);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.coilcontact');
        }
    }
