...
class StateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ArduinoCoilDriver.States.Map.StateTableMap';
     ...
     */
    const OM_CLASS = '\\ArduinoCoilDriver\\States\\State';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ArduinoCoilDriver.States.State';
     ...
     */
    const COL_USER_ID = 'states.user_id';

    /**
     * the column name for the time field
     */
    const COL_TIME = 'states.time';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(StateTableMap::COL_ID, StateTableMap::COL_USER_ID, StateTableMap::COL_TIME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(StateTableMap::COL_ID => 0, StateTableMap::COL_USER_ID => 1, StateTableMap::COL_TIME => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ArduinoCoilDriver\\States\\State');
    ...
    {
        $this->addRelation('User', '\\ArduinoCoilDriver\\Users\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StateTableMap::COL_USER_ID);
            $criteria->addSelectColumn(StateTableMap::COL_TIME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ArduinoCoilDriver\States\State) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(StateTableMap::DATABASE_NAME);
            $criteria->add(StateTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(StateTableMap::COL_ID) && $criteria->keyContainsValue(StateTableMap::COL_ID) ) {
