...
*/
abstract class StateBookmark implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ArduinoCoilDriver\\States\\Map\\StateBookmarkTableMap';
    ...
    /**
     * Compares this with another <code>StateBookmark</code> instance.  If
     * <code>obj</code> is an instance of <code>StateBookmark</code>, delegates to
     * <code>equals(StateBookmark)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|StateBookmark The current object, for fluid interface
     */
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[StateBookmarkTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStateBookmarkQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see StateBookmark::setDeleted()
     * @see StateBookmark::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStateBookmarkQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StateBookmarkTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO state_bookmarks (%s) VALUES (%s)',
    ...
    {
        $pos = StateBookmarkTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['StateBookmark'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StateBookmark'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ArduinoCoilDriver\States\StateBookmark
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ArduinoCoilDriver\States\StateBookmark The current object, for fluid interface
     */
    ...
    {
        $criteria = ChildStateBookmarkQuery::create();
        $criteria->add(StateBookmarkTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArduinoCoilDriver\States\StateBookmark (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArduinoCoilDriver\States\StateBookmark Clone of current object.
     * @throws PropelException
     */
