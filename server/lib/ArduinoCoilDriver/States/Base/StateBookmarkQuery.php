...
/**
 * Base class that represents a query for the 'state_bookmarks' table.
 *
 *
 *
 ...
 * @method     ChildStateBookmarkQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildStateBookmarkQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildStateBookmarkQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildStateBookmarkQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildStateBookmarkQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildStateBookmarkQuery leftJoinState($relationAlias = null) Adds a LEFT JOIN clause to the query using the State relation
 * @method     ChildStateBookmarkQuery rightJoinState($relationAlias = null) Adds a RIGHT JOIN clause to the query using the State relation
 * @method     ChildStateBookmarkQuery innerJoinState($relationAlias = null) Adds a INNER JOIN clause to the query using the State relation
 *
 * @method     ChildStateBookmarkQuery joinWithState($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the State relation
 *
 * @method     ChildStateBookmarkQuery leftJoinWithState() Adds a LEFT JOIN clause and with to the query using the State relation
 * @method     ChildStateBookmarkQuery rightJoinWithState() Adds a RIGHT JOIN clause and with to the query using the State relation
 * @method     ChildStateBookmarkQuery innerJoinWithState() Adds a INNER JOIN clause and with to the query using the State relation
 *
 * @method     \ArduinoCoilDriver\States\StateQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildStateBookmark findOne(ConnectionInterface $con = null) Return the first ChildStateBookmark matching the query
 ...
 *
 */
abstract class StateBookmarkQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \ArduinoCoilDriver\States\Base\StateBookmarkQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ArduinoCoilDriver\\States\\StateBookmark', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildStateBookmarkQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildStateBookmarkQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildStateBookmarkQuery) {
            return $criteria;
        }
        $query = new ChildStateBookmarkQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildStateBookmark|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = StateBookmarkTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
            // the object is already in the instance pool
            return $obj;
        }
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(StateBookmarkTableMap::DATABASE_NAME);
        }
     ...
     *
     * @return ChildStateBookmark A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildStateBookmark $obj */
            $obj = new ChildStateBookmark();
            $obj->hydrate($row);
            StateBookmarkTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(StateBookmarkTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(StateBookmarkTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(StateBookmarkTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(StateBookmarkTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StateBookmarkTableMap::COL_DESCRIPTION, $description, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildStateBookmarkQuery The current query, for fluid interface
     */
     ...
     *
     * @param   ChildStateBookmark $stateBookmark Object to remove from the list of results
     *
     * @return $this|ChildStateBookmarkQuery The current query, for fluid interface
     */
    public function prune($stateBookmark = null)
    {
        if ($stateBookmark) {
            $this->addUsingAlias(StateBookmarkTableMap::COL_ID, $stateBookmark->getId(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            StateBookmarkTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(StateBookmarkTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            StateBookmarkTableMap::removeInstanceFromPool($criteria);
