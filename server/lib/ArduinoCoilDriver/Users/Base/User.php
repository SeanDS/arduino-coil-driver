...
abstract class User implements ActiveRecordInterface
{
    ...
    public function getFirstLogin($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->first_login instanceof \DateTime ? $this->first_login->format($format) : null;
        }
    }
    ...
    public function setFirstLogin($v)
    {
        ...
        if ($this->first_login !== null || $dt !== null) {
            if ($this->first_login === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->first_login->format("Y-m-d H:i:s")) {
                $this->first_login = $dt === null ? null : clone $dt;
                $this->modifiedColumns[UserTableMap::COL_FIRST_LOGIN] = true;
            }
