...
namespace ArduinoCoilDriver\Users\Base;
...
use ArduinoCoilDriver\Users\User as ChildUser;
use ArduinoCoilDriver\Users\UserQuery as ChildUserQuery;
use ArduinoCoilDriver\Users\Map\UserTableMap;
 ...
 *
 *
* @package    propel.generator.ArduinoCoilDriver.Users.Base
*/
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ArduinoCoilDriver\\Users\\Map\\UserTableMap';
    ...
    /**
     * The value for the firstlogin field.
     *
     * @var        \DateTime
     */
    ...
    /**
     * @var        ObjectCollection|State[] Collection to store aggregation of State objects.
     */
    ...
    /**
     * Initializes internal state of ArduinoCoilDriver\Users\Base\User object.
     */
    ...
    /**
     * Get the [optionally formatted] temporal [firstlogin] column value.
     *
     *
     ...
     */
    public function getFirstLogin($format = NULL)
    {
        if ($format === null) {
            return $this->firstlogin;
        } else {
            return $this->firstlogin instanceof \DateTime ? $this->firstlogin->format($format) : null;
        }
    }
    ...
    /**
     * Sets the value of [firstlogin] column to a normalized version of the date/time value specified.
     *
    ...
    public function setFirstLogin($v)
    {
        ...
        if ($this->firstlogin !== null || $dt !== null) {
            if ($this->firstlogin === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->firstlogin->format("Y-m-d H:i:s")) {
                $this->firstlogin = $dt === null ? null : clone $dt;
                $this->modifiedColumns[UserTableMap::COL_FIRSTLOGIN] = true;
            }
    ...
    public function setLastLogin($v)
    {
        ...
        if ($this->lastlogin !== null || $dt !== null) {
            if ($this->lastlogin === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->lastlogin->format("Y-m-d H:i:s")) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->firstlogin = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->statesScheduledForDeletion !== null) {
                if (!$this->statesScheduledForDeletion->isEmpty()) {
                    \ArduinoCoilDriver\States\StateQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_FIRSTLOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'firstlogin';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'role':
                        ...
                        break;
                    case 'firstlogin':
                        $stmt->bindValue($identifier, $this->firstlogin ? $this->firstlogin->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'lastlogin':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collStates) {
                ...
                $result[$key] = $this->collStates->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ArduinoCoilDriver\Users\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ArduinoCoilDriver\Users\User The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_FIRSTLOGIN)) {
            $criteria->add(UserTableMap::COL_FIRSTLOGIN, $this->firstlogin);
        }
        if ($this->isColumnModified(UserTableMap::COL_LASTLOGIN)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ArduinoCoilDriver\Users\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ArduinoCoilDriver\Users\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function initStates($overrideExisting = true)
    {
        ...
        $this->collStates->setModel('\ArduinoCoilDriver\States\State');
    }
     ...
     * @return ObjectCollection|State[] List of State objects
     * @throws PropelException
     */
    public function getStates(Criteria $criteria = null, ConnectionInterface $con = null)
    {
    ...
    /**
     * Returns the number of related BaseState objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related BaseState objects.
     * @throws PropelException
     */
     ...
     */
    protected function doAddState(State $state)
    {
    ...
    public function removeState(State $state)
    {
        if ($this->getStates()->contains($state)) {
            $pos = $this->collStates->search($state);
            $this->collStates->remove($pos);
